...
constexpr size_t INITIAL_HASHES = 1 << 22;      // 4,194,304 initial hashes (4M+ capacity for Stage 2 collision testing)
constexpr size_t STAGE_ENTRIES = 1 << 18;       // 262,144 entries per stage buffer (increased)
